...
const STACK_PATTERNS: Array<[string, RegExp]> = [
  ...
  ["terraform", /terraform|\biac\b/i],
  ["sql", /\bsql\b|postgres|mysql|oracle/i],
  ["nosql", /\bnosql\b|mongodb|\bmongo\b|dynamodb|cassandra/i],
  ["redis", /\bredis\b/i],
  ["kafka", /\bkafka\b|rabbitmq/i],
  ["graphql", /\bgraphql\b/i],
  ["api", /\bapis?\b|desenvolvimento de apis?|\brest\b/i],
  ["git", /\bgit\b/i],
  ...
  ["ai", /\bia\b|\bai\b|intelig[eê]ncia artificial|machine learning|\bml\b|\bllm\b|\bgpt\b/i],
  ["elasticsearch", /elasticsearch|\belastic\b|\belk\b/i],
  ["figma", /\bfigma\b/i],
